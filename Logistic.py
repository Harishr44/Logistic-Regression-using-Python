...
#claimants.drop(claimants.index[[0,1,2,3]],axis=0)
...
claimants.describe() # describe() is like summary function in r
...
#claimants.ATTORNEY.value_counts().index[0] # gets you the most occuring value in the given variable
...
train,test = train_test_split(claimants,test_size=0.3,random_state=0)
...
confusion_matrix
accuracy_train = (361+306)/(938) # 70.14
accuracy_train
...
confusion_matrix
accuracy_test = (126+142)/(402) # 71.39
accuracy_test
